...
const ICON_ROUTE = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    <polygon points="3 11 18 2 13 18 11 13 3 11"/>
</svg>`
...
const NAV_BUTTONS = [
    ...
    { id: 'route',     label: 'Маршрут',       icon: ICON_ROUTE },
]
    ...
    _handleClick(id)
    {
        switch(id)
        {
            case 'home':
                ...
                // Fly camera to center between lounge zones
            ...
            case 'route':
                ...
                this.store.set(
                    'activePanel',
                    this.store.activePanel === 'route' ? null : 'route'
                )
                break
