...
import { CameraAngles } from './CameraAngles.js'
...
export class UIOverlay
{
    constructor()
    {
        ...
        this.cameraAngles = new CameraAngles(this.element)
        this.routePanel = new RoutePanel(this.element)
    ...
    destroy()
    {
        ...
        this.cameraAngles.destroy()
        this.routePanel.destroy()
